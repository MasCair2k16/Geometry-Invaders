...
HD_PWD='C:/Users/iangle22/Desktop/DLD_final/Geometry-Invaders/Geometry_Invaders/Geometry_Invaders.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log squares.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source squares.tcl -notrace
