...
HD_PWD='C:/Users/iangle22/Desktop/DLD_final/Geometry-Invaders/Geometry_Invaders/Geometry_Invaders.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log squares.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source squares.tcl
